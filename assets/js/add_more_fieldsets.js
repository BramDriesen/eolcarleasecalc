...
function add_weekly_calculation_fields() {
    ...
    divtest.innerHTML = '<div class="row"> <div class="col-sm-3 nopadding"> <div class="form-group"> <div class="input-group mb-3"> <input type="number" class="form-control" id="weeklyMileage" name="weeklyMileage[]" placeholder="75"> <div class="input-group-append"> <span class="input-group-text weeklyMileageUnit">km</span> </div></div></div></div><div class="col-sm-3 nopadding"> <div class="form-group"> <div class="input-group mb-3"> <input type="number" class="form-control" id="weeklyTimes" name="weeklyTimes[]" placeholder="5"> <div class="input-group-append"> <span class="input-group-text">Times a week</span> </div></div></div></div><div class="col-sm-6 nopadding"> <div class="form-group"> <div class="input-group mb-3"> <input type="text" class="form-control" id="weeklyComment" name="weeklyComment[]" placeholder="E.g. Home/work"> <div class="input-group-append"> <button class="btn btn-danger" type="button" onclick="remove_weekly_calculation_fields(' + field_group_count + ');"> <i class="fas fa-minus"></i> </button> </div></div></div></div></div>';
